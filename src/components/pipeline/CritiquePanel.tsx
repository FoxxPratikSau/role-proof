...
const convergenceReasonLabel = (reason: string): string => {
  switch (reason) {
    case "score_ceiling":
          ...
          {data.recurringWeaknesses && data.recurringWeaknesses.length > 0 && (
            <div className="mt-1 rounded-md border border-red-600/20 bg-red-600/5 px-3 py-2">
              <p className="text-xs font-medium text-red-600 dark:text-red-400">
                ...
                {data.recurringWeaknesses.length > 1
                  ? "multiple iterations"
                  : "previous iteration"}
                )
              </p>
                  ...
                  return (
                    <div key={entry.iteration}>
                      ...
                      >
                        ...
                        <span
                          className={`font-semibold tabular-nums ${entryColor}`}
                        >
