    ...
    <div className="flex flex-col gap-4">
      <Tabs defaultValue="upload">
        ...
        <TabsContent value="upload" className="mt-4">
          <button
            type="button"
            className={`focus-visible:ring-ring/20 flex min-h-[280px] flex-col items-center justify-center gap-4 rounded-xl border-2 border-dashed p-8 text-center transition-colors focus-visible:ring-3 focus-visible:outline-none ${isDragOver ? "border-primary bg-primary/5" : "border-input bg-background hover:border-primary/60 hover:bg-primary/[0.025]"}`}
