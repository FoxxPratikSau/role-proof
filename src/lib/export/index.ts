...
export const downloadTxt = (
  resume: string,
  filename: string = "roleproof-resume.txt",
): void => {
...
export const downloadDocx = async (
  resume: string,
  filename: string = "roleproof-resume.docx",
): Promise<void> => {
...
export const downloadPdf = async (
  resume: string,
  filename: string = "roleproof-resume.pdf",
): Promise<void> => {
...
const generateDocxBlob = async (resume: string): Promise<Blob> => {
...
const generatePdfBlob = async (resume: string): Promise<Blob> => {
  const sections = parseResumeSections(resume);
...
export const downloadTex = (
  tex: string,
  filename: string = "roleproof-resume.tex",
): void => {
